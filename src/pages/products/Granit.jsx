...
const DUMMY_IMAGES = {
  ...
  steelGrey:
    "https://images.unsplash.com/photo-1544207240-8b1025eb7a6c?auto=format&fit=crop&q=80&w=600",
  riverWhite:
    "https://images.unsplash.com/photo-1635012684880-acc3c43ffd55?auto=format&fit=crop&q=80&w=600",
  tanBrown:
    "https://images.unsplash.com/photo-1517646287270-a5a9ca602e5c?auto=format&fit=crop&q=80&w=600",
  absoluteBlack:
    "https://images.unsplash.com/photo-1507499739999-097706ad8914?auto=format&fit=crop&q=80&w=600",
...
const Granite = () => {
  ...
  const collectionData = [
    {
      name: "Black Galaxy",
      origin: "Premium Indian Quarry",
      image: DUMMY_IMAGES.blackGalaxy,
    },
    {
      name: "Alaska White",
      origin: "Imported Exotic Selection",
      image: DUMMY_IMAGES.alaskaWhite,
    },
    {
      name: "Steel Grey",
      origin: "Classic Fine Grain",
      image: DUMMY_IMAGES.steelGrey,
    },
    {
      name: "River White",
      origin: "Smooth Linear Veining",
      image: DUMMY_IMAGES.riverWhite,
    },
    {
      name: "Tan Brown",
      origin: "Deep Rich Crystalline",
      image: DUMMY_IMAGES.tanBrown,
    },
    {
      name: "Absolute Black",
      origin: "Pure Deep Matrix",
      image: DUMMY_IMAGES.absoluteBlack,
    },
  ];
  ...
  const featuresData = [
    {
      ...
      description:
        "Vitreous crystalline assembly capable of resisting immense load vectors without shear stress structural fractures.",
    },
    {
      title: "Heat Resistant",
      description:
        "Formed under igneous conditions, it preserves surface stability under elevated temperatures without thermal expansion damage.",
    },
    {
      title: "Scratch Resistant",
      description:
        "Registers at 6–7 on the Mohs Hardness scale. Defies friction markings from steel utility tooling safely.",
    },
    {
      title: "Low Maintenance",
      description:
        "Ultra-compact surface porosities prevent fluid stagnation stains when calibrated with our custom stone sealants.",
    },
    {
      title: "Natural Beauty",
      description:
        "Irregular crystal clusters guarantee that no two matching slabs will ever yield duplicate patterns.",
    },
    {
      title: "Long Lifespan",
      description:
        "Maintains surface integrity for generations, defying environmental wear in both interior and exterior environments.",
    },
  ];

  const finishesData = [
    {
      name: "Polished Finishes",
      description:
        "A high-gloss specular presentation reflecting 90%+ light values to deeply highlight natural color depth.",
      image: DUMMY_IMAGES.polished,
    },
    {
      name: "Honed Finishes",
      description:
        "Satin, zero-glare layout surface providing smooth tactical values with slip-resistant friction metrics.",
      image: DUMMY_IMAGES.honed,
    },
    {
      name: "Leather Finishes",
      description:
        "Textured contour lines tracking softer stone pockets to render an organic leather-like feel.",
      image: DUMMY_IMAGES.leather,
    },
  ];
  ...
  const showcaseData = [
    {
      ...
      location: "Mumbai, MH",
      scope:
        "Exterior facade clad configuration spanning 45,000 Sq. Ft. absolute absolute matching matrix.",
    ...
    },
    {
      ...
      location: "Alibaug",
      scope:
        "Custom monolithic kitchen culinary counters combined with matching bookmatched flooring arrays.",
