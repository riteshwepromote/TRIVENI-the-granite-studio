...
// Real, high-resolution Unsplash photography showcasing luxury Monolith tiles and architectural porcelain slabs
const MONOLITH_IMAGES = {
  // Hero: Modern luxury interior featuring Monolith large-format tiles
  ...
  monolithCalacatta: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800",
  monolithBasalt: "https://images.unsplash.com/photo-1507499739999-097706ad8914?auto=format&fit=crop&q=80&w=800",
  monolithTerrazzo: "https://images.unsplash.com/photo-1590381105924-c72589b9ef3f?auto=format&fit=crop&q=80&w=800",
  monolithTravertine: "https://images.unsplash.com/photo-1504198453319-5ce911bafcde?auto=format&fit=crop&q=80&w=800",
  monolithConcrete: "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?auto=format&fit=crop&q=80&w=800",
  monolithOxide: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=800",
...
const Monolith = () => {
  ...
  const collectionData = [
    { name: "Monolith Calacatta Gold", origin: "High-Definition Italian Marble Replication", image: MONOLITH_IMAGES.monolithCalacatta },
    { name: "Monolith Basalt Dark", origin: "Deep Volcanic Stone Look", image: MONOLITH_IMAGES.monolithBasalt },
    { name: "Monolith Modern Terrazzo", origin: "Contemporary Aggregate Composite", image: MONOLITH_IMAGES.monolithTerrazzo },
    { name: "Monolith Vein Travertine", origin: "Linear Earth-Tone Architectural Profile", image: MONOLITH_IMAGES.monolithTravertine },
    { name: "Monolith Urban Concrete", origin: "Industrial Minimalist Surface", image: MONOLITH_IMAGES.monolithConcrete },
    { name: "Monolith Oxide Metal", origin: "Aged Industrial Metal Fusion", image: MONOLITH_IMAGES.monolithOxide },
  ];
  ...
  const finishesData = [
    { 
      ...
      image: MONOLITH_IMAGES.glossyMirror 
    },
    { 
      ...
      image: MONOLITH_IMAGES.velvetMatte 
    },
    { 
      ...
      image: MONOLITH_IMAGES.sugarGrip 
    },
  ];
  ...
  const showcaseData = [
    {
      ...
      location: "New Delhi",
      scope: "Large-format polished Monolith porcelain flooring covering 50,000 sq. ft. of elite hospitality corridors and suites.",
      image: MONOLITH_IMAGES.project1
    },
    {
      ...
      image: MONOLITH_IMAGES.project2
    }
  ];

  return (
    <ProductsPage
      title="Monolith Tiles"
      subtitle="Architectural Porcelain & Vitrified Slabs. Crafted for Excellence."
      heroDescription="Experience Monolith tiles—advanced porcelain surfaces that merge the exquisite beauty of rare natural stones with the exceptional resilience of modern vitrified technology."
      heroImage={MONOLITH_IMAGES.hero}
      aboutTitle="The Art of Monolith Vitrified Porcelain"
      aboutText={`Monolith defines the zenith of modern surface design, fusing select natural raw minerals and high-grade clays under massive hydraulic tonnage and extreme kiln heat.\n\nUnlike traditional natural stone, Monolith tiles demand no complicated sealing upkeep, offer robust defense against scratching and staining, and maintain absolute pattern consistency. From luxury hospitality environments to high-end residential interiors, Monolith delivers an enduring foundation for immaculate design.`}
      aboutImage={MONOLITH_IMAGES.about}
