...
// Real, high-resolution Unsplash photography showcasing luxury Arvia tiles and architectural porcelain slabs
const ARVIA_IMAGES = {
  // Hero: Modern luxury interior featuring Arvia large-format tiles
  ...
  arviaCalacatta: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800",
  arviaBasalt: "https://images.unsplash.com/photo-1507499739999-097706ad8914?auto=format&fit=crop&q=80&w=800",
  arviaTerrazzo: "https://images.unsplash.com/photo-1590381105924-c72589b9ef3f?auto=format&fit=crop&q=80&w=800",
  arviaTravertine: "https://images.unsplash.com/photo-1504198453319-5ce911bafcde?auto=format&fit=crop&q=80&w=800",
  arviaConcrete: "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?auto=format&fit=crop&q=80&w=800",
  arviaOxide: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=800",
...
const Arvia = () => {
  ...
  const collectionData = [
    { name: "Arvia Calacatta Gold", origin: "High-Definition Italian Marble Replication", image: ARVIA_IMAGES.arviaCalacatta },
    { name: "Arvia Basalt Dark", origin: "Deep Volcanic Stone Look", image: ARVIA_IMAGES.arviaBasalt },
    { name: "Arvia Modern Terrazzo", origin: "Contemporary Aggregate Composite", image: ARVIA_IMAGES.arviaTerrazzo },
    { name: "Arvia Vein Travertine", origin: "Linear Earth-Tone Architectural Profile", image: ARVIA_IMAGES.arviaTravertine },
    { name: "Arvia Urban Concrete", origin: "Industrial Minimalist Surface", image: ARVIA_IMAGES.arviaConcrete },
    { name: "Arvia Oxide Metal", origin: "Aged Industrial Metal Fusion", image: ARVIA_IMAGES.arviaOxide },
  ];
  ...
  const finishesData = [
    { 
      ...
      image: ARVIA_IMAGES.glossyMirror 
    },
    { 
      ...
      image: ARVIA_IMAGES.velvetMatte 
    },
    { 
  ...
  const showcaseData = [
    {
      ...
      location: "New Delhi",
      scope: "Large-format polished Arvia porcelain flooring covering 50,000 sq. ft. of elite hospitality corridors and suites.",
      image: ARVIA_IMAGES.project1
    },
    {
  ...
  return (
    <ProductsPage
      ...
      heroDescription="Experience Arvia tiles—advanced porcelain surfaces that merge the exquisite beauty of rare natural stones with the exceptional resilience of modern vitrified technology."
      heroImage={ARVIA_IMAGES.hero}
      aboutTitle="The Art of Arvia Vitrified Porcelain"
      aboutText={`Arvia defines the zenith of modern surface design, fusing select natural raw minerals and high-grade clays under massive hydraulic tonnage and extreme kiln heat.\n\nUnlike traditional natural stone, Arvia tiles demand no complicated sealing upkeep, offer robust defense against scratching and staining, and maintain absolute pattern consistency. From luxury hospitality environments to high-end residential interiors, Arvia delivers an enduring foundation for immaculate design.`}
      aboutImage={ARVIA_IMAGES.about}
