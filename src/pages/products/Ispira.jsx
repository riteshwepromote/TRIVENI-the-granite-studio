...
// Real, high-resolution Unsplash photography showcasing luxury Ispira architectural tiles and porcelain slabs
const ISPIRA_IMAGES = {
  // Hero: Modern luxury interior featuring Ispira large-format tiles
  ...
  ispiraCalacatta: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&q=80&w=800",
  ispiraBasalt: "https://images.unsplash.com/photo-1507499739999-097706ad8914?auto=format&fit=crop&q=80&w=800",
  ispiraTerrazzo: "https://images.unsplash.com/photo-1590381105924-c72589b9ef3f?auto=format&fit=crop&q=80&w=800",
  ispiraTravertine: "https://images.unsplash.com/photo-1504198453319-5ce911bafcde?auto=format&fit=crop&q=80&w=800",
  ispiraConcrete: "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?auto=format&fit=crop&q=80&w=800",
  ispiraOxide: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=800",
...
const Ispira = () => {
  ...
  const collectionData = [
    { name: "Ispira Calacatta Gold", origin: "High-Definition Italian Marble Replication", image: ISPIRA_IMAGES.ispiraCalacatta },
    { name: "Ispira Basalt Dark", origin: "Deep Volcanic Stone Look", image: ISPIRA_IMAGES.ispiraBasalt },
    { name: "Ispira Modern Terrazzo", origin: "Contemporary Aggregate Composite", image: ISPIRA_IMAGES.ispiraTerrazzo },
    { name: "Ispira Vein Travertine", origin: "Linear Earth-Tone Architectural Profile", image: ISPIRA_IMAGES.ispiraTravertine },
    { name: "Ispira Urban Concrete", origin: "Industrial Minimalist Surface", image: ISPIRA_IMAGES.ispiraConcrete },
    { name: "Ispira Oxide Metal", origin: "Aged Industrial Metal Fusion", image: ISPIRA_IMAGES.ispiraOxide },
  ];
  ...
  const finishesData = [
    { 
      ...
      image: ISPIRA_IMAGES.glossyMirror 
    },
    { 
      ...
      image: ISPIRA_IMAGES.velvetMatte 
    },
    { 
  ...
  const showcaseData = [
    {
      ...
      location: "New Delhi",
      scope: "Large-format polished Ispira porcelain flooring covering 50,000 sq. ft. of elite hospitality corridors and suites.",
      image: ISPIRA_IMAGES.project1
    },
    {
  ...
  return (
    <ProductsPage
      ...
      heroDescription="Experience Ispira tiles—advanced porcelain surfaces that merge the exquisite beauty of rare natural stones with the exceptional resilience of modern vitrified technology."
      heroImage={ISPIRA_IMAGES.hero}
      aboutTitle="The Art of Ispira Vitrified Porcelain"
      aboutText={`Ispira defines the zenith of modern surface design, fusing select natural raw minerals and high-grade clays under massive hydraulic tonnage and extreme kiln heat.\n\nUnlike traditional natural stone, Ispira tiles demand no complicated sealing upkeep, offer robust defense against scratching and staining, and maintain absolute pattern consistency. From luxury hospitality environments to high-end residential interiors, Ispira delivers an enduring foundation for immaculate design.`}
      aboutImage={ISPIRA_IMAGES.about}
